    ...
    <>
      ...
      <section id="services">
        ...
        <div className="services-grid">
          ...
          <ScrollReveal>
            <div className="service-card" onClick={() => handleServiceClick('third-party-payroll')}>
              <div className="service-icon">🤝</div>
              <h3>Third Party Payroll</h3>
              <p>Simplify payroll, compliance, and administrative burdens for contract and off-roll employees. Maintain operational agility and cost efficiency seamlessly.</p>
              <div className="service-tags">
                <span className="service-tag">Off-Roll Staff</span>
                <span className="service-tag">Contract Compliance</span>
                <span className="service-tag">Onboarding & KYC</span>
              </div>
            </div>
          </ScrollReveal>
                ...
                <form onSubmit={submitBooking}>
                  ...
                  <div className="form-group">
                    ...
                    <select id="service" value={formData.service} onChange={handleInputChange} required>
                      ...
                      <option value="Third Party Payroll (Off-roll Staff)">Third Party Payroll (Off-roll Staff)</option>
