                  ...
                  <div className="card">
                    <div className="card-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1rem' }}>
                      ...
                      <div style={{ display: 'flex', gap: '0.5rem' }}>
                        <button className="btn btn-primary btn-sm text-white " style={{ background: 'var(--navy2)', fontSize: '0.75rem' ,color: 'white' }} onClick={() => triggerCSVDownload(processedEnquiries, 'filtered_enquiries')}>
